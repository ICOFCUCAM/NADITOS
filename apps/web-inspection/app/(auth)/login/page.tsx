...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("inspector@demo");
      ...
      <aside aria-hidden
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full
            ...
            Inspection authority · Station console
          </div>
          <h1 className="text-[clamp(2.4rem,1.6rem+3vw,3.8rem)] leading-[0.95]
                         text-[var(--fg-primary)] font-semibold tracking-tight"
              style={{ fontFamily: "var(--ff-display)" }}>
            National vehicle <br/>
            <span className="text-[var(--accent-primary)]">inspection authority.</span>
          </h1>
          <p className="text-[var(--fg-secondary)] max-w-md leading-relaxed">
            Schedule inspections, certify vehicles, and feed compliance
            status into the central registry. Authenticate to enter the
            inspection console.
          </p>
        </div>
      </aside>
      ...
      <main className="flex items-center justify-center p-6 sm:p-12">
        <form onSubmit={onSubmit}
          ...
          <Button type="submit" disabled={busy} fullWidth size="lg" tone="primary">
            {busy ? "Authenticating…" : "Enter inspection console"}
          </Button>
