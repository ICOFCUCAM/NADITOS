      ...
      <aside aria-hidden
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full
            ...
            Ministry oversight · Command terminal
          </div>
          <h1 className="text-[clamp(2.4rem,1.6rem+3vw,3.8rem)] leading-[0.95]
            ...
            <span className="text-[var(--accent-primary)]">intelligence platform.</span>
          </h1>
          <p className="text-[var(--fg-secondary)] max-w-md leading-relaxed">
            Real-time fleet compliance, enforcement audit, and provider
            health under one sealed ledger. Authenticate to enter the
            command center.
          </p>
        </div>
      </aside>
